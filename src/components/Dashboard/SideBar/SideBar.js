    ...
    <div className='side-bar'>
      ...
      </Link>
      {
        isAdmin ? <div>
          ...
          <NavLink activeClassName='active' className='admin-option d-flex px-3 px-sm-5 py-3' to="/dashboard/add-orders">
          ...
          <NavLink activeClassName='active' className='admin-option d-flex px-3 px-sm-5 py-3' to="/dashboard/manage-orders">
          ...
          <div>
            ...
            <NavLink activeClassName='active' className='admin-option d-flex px-3 px-sm-5 py-3' to="/dashboard/orders-list">
              <FontAwesomeIcon icon={faList} className=' icon' />
              <h6>&nbsp; Orders List</h6>
            </NavLink>
      ...
      <Button onClick={logout} className='admin-option d-flex px-3 px-sm-5 py-3' variant="primary" type="submit">logout</Button>
