                    ...
                    <div>
                        <Form onSubmit={handleLoginSubmit}>
                            ...
                            <Form.Group className="mb-3" controlId="formBasicPassword2">
                                <Form.Control onBlur={handleOnBlur} name="password2" type="password" placeholder="Retype Password" />
                            </Form.Group>
                            <Button variant="primary" type="submit">
                                Submit
                            </Button>
                        </Form>
                        <Link to="/login">Are you alradey register User?</Link>
                        {user?.email && <Alert variant="success">User Creat success!</Alert>}
