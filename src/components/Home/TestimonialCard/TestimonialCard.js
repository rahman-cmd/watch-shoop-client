...
const TestimonialCard = ({ feedback }) => {
  ...
  return (
    <div className='col-md-4 col-12'>
      <div className="card testimonialCard p-5 d-flex flex-column align-items-center justify-content-between">
        <div className="client-image-div">
          <img src={image} alt="" className="img-fluid client-image" />
        </div>
        <div className="card-discription mt-4">
          <p className='text-center'><i>"{discription}"</i></p>
        </div>
